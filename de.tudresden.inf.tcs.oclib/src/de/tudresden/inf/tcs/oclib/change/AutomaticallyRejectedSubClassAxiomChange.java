...
public class AutomaticallyRejectedSubClassAxiomChange extends AbstractContextModification {

	private FCAImplication<OWLClass> implication;

	public AutomaticallyRejectedSubClassAxiomChange(IndividualContext c, FCAImplication<OWLClass> i) {
		super(c,null);
		implication = i;
	}
